...
- **남음 (다음 세션, handoff `docs/handoff-memory-layer-pr1-2c.md`)**: PR5(안전·decay·graceful shutdown·active cap archive) + PR3c(fuzzy 병합·cross-run confidence, optional) + a11y·visual route 배열 #memory 추가. spec `docs/specs/memory-layer-brief.md` §10.
