...
-- the fresh spawn boundary. Migration 079 fills the NULL left on pre-existing
-- manager runs; '{}' means a new run explicitly had no template options and
-- must not inherit later profile edits.
