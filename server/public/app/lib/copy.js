...
export const DIRECTORY_PICKER_LABELS = {
  fieldLabel: '디렉터리',
  inputPlaceholder: '코드베이스 디렉터리 선택...',
  browse: '찾아보기',
  clear: '디렉터리 지우기',
  modalTitle: '디렉터리 선택',
  showHidden: '숨김 항목 표시',
...
export const PROJECTS_LABELS = {
  pageTitle: '코드베이스',
  newProject: '새 코드베이스',
  emptyText: '아직 코드베이스가 없습니다.',
  emptySub: '작업을 정리하려면 코드베이스를 생성하세요.',
  taskCountSuffix: '개',
  taskWord: '개 작업',
  detailTitle: '코드베이스 상세',
  directoryLabel: '디렉터리',
  ...
  createdLabel: '생성',
  tasksSection: '작업',
  noTasks: '이 코드베이스에 할당된 작업이 없습니다.',
  runSingular: '회 실행',
  // Modal — new / edit
  modalNew: '새 코드베이스',
  modalEdit: '코드베이스 편집',
  fieldName: '이름',
  namePlaceholder: '코드베이스 이름',
  fieldDescription: '설명',
  descriptionPlaceholder: '선택 사항',
  sourceTypeLabel: '코드베이스 소스',
  ...
  mcpConfigPathHint: 'Claude CLI --mcp-config 용 코드베이스 범위 MCP 서버 설정 파일',
  ...
  retargetQueuedBannerDetail: '코드베이스 노드는 바뀌었지만 기존 대기열 작업은 아직 옛 노드에 고정되어 있을 수 있습니다.',
  ...
  operatorWatchersPrefix: '이 코드베이스를 보는 오퍼레이터 ',
...
export const TOAST_LABELS = {
  ...
  loadFailedProjects: '코드베이스를 불러오지 못했습니다',
...
export const NODES_LABELS = {
  ...
  deleteHint: '코드베이스에 바인딩된 노드는 서버가 삭제를 거부합니다.',
  deleting: '삭제 중...',
...
export const SKILL_PACKS_LABELS = {
  ...
  filterScopeProject: '코드베이스',
  filterAllProjects: '전체 코드베이스',
  filterScopeAria: '범위 필터',
  filterProjectAria: '코드베이스 필터',
  packsCountSuffix: '개',
  // Token budget
  tokenBudget: '토큰 예산',
  // Empty state
  ...
  // Delete
  deleteTitle: '스킬 팩 삭제',
  deleteBodySuffix: ' 을(를) 삭제할까요? 모든 코드베이스와 작업 바인딩이 함께 제거됩니다.',
...
export const OPERATOR_ROSTER_LABELS = {
  pageTitle: '오퍼레이터 로스터',
  pageDescription: 'Top, 코드베이스 바인딩 오퍼레이터, 폴더 없는 호출형 오퍼레이터를 분리해서 봅니다.',
  unknownValue: 'unknown',
  unknownProject: '알 수 없는 코드베이스',
  localNode: 'local',
  ...
  referenceRefRole: '참조',
  addReference: '참조 추가',
  addReferenceTitle: '참조 코드베이스 추가',
  referenceProjectLabel: '코드베이스',
  noReferenceProjects: '추가할 코드베이스가 없습니다',
  removeReference: '참조 제거',
  liveEmptyText: '코드베이스 바인딩 오퍼레이터가 없습니다',
  liveEmptySub: '코드베이스 대화가 시작되면 이 섹션에 표시됩니다.',
  openConversation: '대화',
  openProject: '코드베이스',
