...
export const COMMON_ACTIONS = {
  ...
  sending: '보내는 중...',
  deleting: '삭제 중...',
  discardChanges: '저장하지 않은 변경사항을 버릴까요?',
};
...
export const NODES_LABELS = {
  ...
  validateSshPort: 'SSH 포트는 1~65535 사이의 정수여야 합니다',
...
export const OPERATOR_ROSTER_LABELS = {
  ...
  currentMappings: '현재 매핑',
  noCurrentMappings: '현재 매핑된 코드베이스가 없습니다.',
  addMapping: '매핑 추가',
  ...
  briefPersonaScope: '오퍼레이터 전체',
  briefPersonaHelp: '이 프로필을 공유하는 모든 오퍼레이터와 specialist 호출에 적용됩니다.',
  briefPersonaPlaceholder: '이 오퍼레이터의 역할, 판단 기준, 위임 방식을 설명하세요.',
  briefConventionsLabel: '코드베이스 규칙',
  briefProjectScope: '코드베이스 공통',
  briefConventionsHelp: '이 코드베이스를 보는 모든 오퍼레이터가 공유합니다.',
  ...
  referenceProjectLabel: '추가할 코드베이스',
  noReferenceProjects: '이미 모든 코드베이스가 매핑되어 있습니다.',
  mappingRoleLabel: '역할',
  mappingPrimaryRole: '담당(primary)',
  mappingReferenceRole: '참조(reference)',
  mappingRoleHelp: '참조(reference)는 디스패치 권한 없이 컨텍스트 참조와 watch에 사용됩니다.',
  removeMapping: '매핑 해제',
